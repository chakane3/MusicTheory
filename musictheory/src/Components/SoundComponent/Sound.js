...
(async () => {
    await AudioContext.audioWorklet.addModule('pluck-processor.js')
})()
...
export async function pluck(frequency) {
...
export function strum(fret, stringCount = 6, stagger = 25) {
...
export function getFrequency(string, fret) {
    // Concert A frequency
    const A = 110;
